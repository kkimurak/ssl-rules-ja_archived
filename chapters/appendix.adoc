...
* Division A はDivision Bよりも大きなフィールドとlarger ゴールで試合を行う。その結果、シュートアウトもより遠くから行われる。 +
