...
=== フィールド外にボールが出た際のイベント/Events For Ball Leaving Field
|===
| イベント /Event | 適用範囲 /Applicability | 実行されるコマンド /Command | 処理担当 /Handled by
...
| <<ゴールの得点方法/Scoring Goals, ゴール>> +
<<ゴールの得点方法/Scoring Goals, Goal>>
| <<インプレイとアウトオブプレイ/Ball In And Out Of Play, インプレイ>> +
<<インプレイとアウトオブプレイ/Ball In And Out Of Play, ball in play>>
...
| <<ゴールの得点方法/Scoring Goals, 無効なゴール>> +
<<ゴールの得点方法/Scoring Goals, Invalid Goal>> 
| <<インプレイとアウトオブプレイ/Ball In And Out Of Play, インプレイ>> +
<<インプレイとアウトオブプレイ/Ball In And Out Of Play, ball in play>>
| <<停止/Stop, ストップ>> -> <<フリーキック/Free Kick, フリーキック>> +
<<停止/Stop, Stop>> -> <<フリーキック/Free Kick, Free Kick>>
...
| <<試合の進展なし/No Progress In Game, 試合の進展なし>> +
<<試合の進展なし/No Progress In Game, No Progress In Game>>
| <<インプレイとアウトオブプレイ/Ball In And Out Of Play, インプレイ>> +
<<インプレイとアウトオブプレイ/Ball In And Out Of Play, ball in play>>
